...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--filepath", type=str, required=True, help="The path to the json file")
    ...
    def handle(self, *args, **options) -> None:
        ...
        self.stdout.write(self.style.SUCCESS(f"Loaded {len(Asset.objects.all())} assets"))
